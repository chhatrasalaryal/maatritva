...
public class UsercommonQuestions extends HttpServlet {
	@Override
	...
	if(action.equals("get"))
	{
	 ...
	 rd1=req.getRequestDispatcher("/jsp/user/CreateQuestions.jsp");
	...
	if(Utility.parse1(req.getParameter("add")).equals("YES"))
	{
		...
		int qno=	   TextSearch.text_count1(key_data,uid,question,question_type);
			...
			System.out.println("qno is >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"+qno);   
			  ...
			  rd1=req.getRequestDispatcher("/jsp/user/CreateQuestions.jsp?no=1");
				rd1.forward(req, resp);
			...
			{
				rd1=req.getRequestDispatcher("/jsp/user/CreateQuestions.jsp?no=3");
				rd1.forward(req, resp);
			}
	   }
			  ...
			  String	question = req.getParameter("question");
				...
				String dat = TextSearch.text_Search(data2);
				 ...
				 System.out.println("List Of words :"+dat);
		          ...
		          matcheddata=	 AdminDAO.checkkeyword(key_data.get(i).toString());
				   ...
				   if(sb.toString().equals("")||sb.toString().isEmpty() || sb.toString()==null)
				   {
						...
						rd1=req.getRequestDispatcher("/jsp/user/CreateQuestions.jsp?no=9");
						rd1.forward(req, resp);   
	      ...
	      for(int i=0;i<uniqueno.length;i++)
		   {
	    	  ...
	    	  AdminDAO.insertintofinaltemp1(uniqueno[i],userid);
	        ...
	        ResultSet rs= AdminDAO.finalrankedresults();	
			req.setAttribute("rs",rs);
			rd1=req.getRequestDispatcher("/jsp/user/similarposts.jsp");
			rd1.forward(req, resp);
