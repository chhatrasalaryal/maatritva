...
<form action="<%=request.getContextPath()%>/ExpertLogin" method="post">
<center>
<label ><font size="6" style="font-style: italic;" >EXPERTS LOGIN PAGE</font></label><br/><br/>
</center>
...
%>       
    		<script type="text/javascript">
    			alert('Expert Logged out Successfully');
    			</script>
