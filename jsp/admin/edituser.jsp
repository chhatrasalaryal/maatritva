...
<%!
	ResultSet rs = null;
	String busno=null;
	String uid="",upass="",uname="",uage="",ucity="",ustate="",ugyano="",usex="",upsattuis="",uprob="",umail="",uphone="";
	int ucode=0;
%>
	...
	if(rs != null)
	{
		if(rs.next())
		{
			  ucode = rs.getInt(1);
	   		 ...
	   		 uage = rs.getString(5);
	   		 ucity = rs.getString(6);
	   		 ustate = rs.getString(7);
	   		 ugyano = rs.getString(8);
	   		 usex = rs.getString(9);
	   		upsattuis = rs.getString(10);
	   		uprob = rs.getString(11);
	   		umail = rs.getString(12);
	   		uphone = rs.getString(13);
		}
	}
%>
        ...
        <div class="con-info">
		  ...
		  <div class='container'>
            ...
            <div class="col-md-6 col-sm-6"> <i class="ion-flag"></i>
              ...
              <h4><font style=" font-style: italic;">USER UPDATION PAGE</font></h4>
              <div id="contact_form">
                  ...
                  <div class="row">
                   ...
                   <div class="col-sm-6">
                      <div class="form-group">
                          <label>USER ID</label>
                          <input style="color:  #000000;" value="<%=uid %>" name="uid" type="text"  readonly="readonly" placeholder="User Id"/>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                          ...
                          <input style="color:  #000000;" value="<%=uname %>" name="name" type="text" placeholder="User Id"/>
                      ...
                      <div class="form-group">
                       <label>USER AGE</label>
                          <input style="color:  #000000;" value="<%=uage %>"  name="age" type="text" placeholder="Age"/>
                     ...
                     <div class="col-sm-6">
                      <div class="form-group">
                       <label>USER CITY</label>
                          <input style="color:  #000000;" value="<%=ucity %>" name="city" type="text" placeholder="City"/>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                       <label>USER STATE</label>
                          <input style="color:  #000000;" value="<%=ustate%>" name="state" type="text" placeholder="State"/>
             ...
             <div class="col-sm-6">
                      <div class="form-group">
                       <label>USER GYANO</label>
                          <input style="color:  #000000;" value="<%=ugyano%>" name="gyano" type="text" placeholder="State"/>
                 ...
                 <div class="col-sm-6">
                      <div class="form-group">
                       <label>USER STATUS</label>
                          <input style="color:  #000000;" value="<%=upsattuis%>" name="status" type="text" placeholder="State"/>
			...
			<td>
			 ...
			 <td width="200px"></td>	
                    ...
                    <div class="col-md-12">
                     <div class="form-group">
                      <label> USER PROBLEM       </label>
                        <textarea style="color: #000000;"  name="spec" placeholder="Your Specialization"><%=uprob%></textarea>
                  ...
                  <div class="col-sm-6">
                      <div class="form-group">
                       <label>EMAIL</label>
                          <input  style="color:  #000000;"  value="<%=umail%>"  id="email" name="email"  name="eamil" type="email" onblur="validateEmail(this);" placeholder="Email"/>
                      ...
                      <div class="form-group">
                       <label>CELL NO</label>
                          <input  style="color: #000000;" id="cell" name="cell"  value="<%=uphone%>" type="text"   maxlength="10" placeholder="Cell No"/>
                   
                    <input type="hidden" name="edit" value="YES"></input>
					  
					    <input type="hidden" name="id" value="<%=ucode%>"></input>
