        ...
        <div class="con-info">
		  ...
		  <div class='container'>
            ...
            <div class="col-md-6 col-sm-6"> <i class="ion-flag"></i>
              ...
              <h4><font style=" font-style: italic;">ADMIN CHANGE PASSWORD PAGE</font></h4>
              <div id="contact_form">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                          ...
                          <input style="color:  #000000;" name="adminid" type="text" value="<%=adminid%>"   readonly="readonly" placeholder="User Id" required/>
