        ...
        <div class="con-info">
		  ...
		  <div class='container'>
            ...
            <div class="col-md-6 col-sm-6"> <i class="ion-flag"></i>
              ...
              <div id="contact_form">
              	<form action="<%=request.getContextPath()%>/EditGyaeno"   method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                          <label>NAME</label>
                          <input style="color:  #000000;" name="name"  value="<%=gname %>" type="text" placeholder="Name"/>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                       <label>AGE</label>
                          <input style="color:  #000000;" name="age"  value="<%=gage %>"  type="text" placeholder="Age"/>
                      ...
                      <div class="form-group">
                       <label>CITY</label>
                          <input style="color: #000000;" name="city" value="<%=gcity %>"  type="text" placeholder="State"/>
                     ...
                     <div class="col-sm-6">
                      <div class="form-group">
                       <label>STATE</label>
                          <input style="color: #000000;" name="state" value="<%=gsatte %>" type="text" placeholder="State"/>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                       <label>EMAIL</label>
                          <input style="color:  #000000;" name="email" type="text" value="<%=gmail %>"   onblur="validateEmail(this);" placeholder="Email"/>
                      ...
                      <div class="form-group">
                       <label>PHONE</label>
                          <input style="color:  #000000;" name="phone" type="text"  value="<%=gcell %>" maxlength="10" placeholder="Phone"/>
                    ...
                    <div class="col-md-12">
                     <div class="form-group">
                      <label> SPECIALIZATION       </label>
                        <textarea style="color: #000000;"  name="spec" placeholder="Your Specialization"><%=gspec %></textarea>
