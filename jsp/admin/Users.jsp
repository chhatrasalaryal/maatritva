...
<footer class="shym-contact">
      ...
      <div class="container"> 
        ...
        <div class="con-info">
         ...
         <h4><font style=" font-style: italic;">USERS PAGE</font></h4>
              <div id="contact_form">
               <form name="myForm" action="<%=request.getContextPath()%>/Users">
...
<script type="text/javascript">
    	alert('Users Details Deleted Successfully.....');
