        ...
        <div class="con-info">
		  ...
		  <div class='container'>
            ...
            <div class="col-md-6 col-sm-6"> <i class="ion-flag"></i>
              ...
              <div id="contact_form">
              	<form action="<%=request.getContextPath()%>/AnswerPrivateQuestions"   method="get" >
			...
			%>
                      <label >QUESTION       </label>
                        <input type="text" style="color: #000000;"  id="message" name="question" value="<%=rs.getString(3) %>" >
                                    <label> ANSWER       </label>
                    <input  type="text"  style="color: #000000;"  id="message" name="answer">
                    <input type="hidden" name="qno" value="<%=rs.getInt(1)%>"> 
               <%} %> 
						  ...
						  <input name="action" type="submit" value="POST_ANSWER"/>
                      </div>
                    </div>
