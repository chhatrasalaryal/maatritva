...
%>
<% 
ResultSet rs1=         AdminDAO.getgynocologist();
String user=(String)session.getAttribute("ucode");
ResultSet rs=         AdminDAO.getUsesr11(Integer.parseInt(user));
while(rs.next())
{
	ucode=rs.getInt(1);
	uid=rs.getString(2);
        ...
        <div class="con-info">
		  ...
		  <div class='container'>
            ...
            <form action="<%=request.getContextPath()%>/UserView" method="get">
              <h4><font style=" font-style: italic;">USER DETAILS UPDATION PAGE</font></h4>
              <div id="contact_form">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                          <label>USER ID</label>
                          <input style="color:  #000000;" value="<%=uid %>" name="uid" readonly="readonly" type="text" placeholder="User Id"/>
                     ...
                     <div class="col-sm-6">
                      <div class="form-group">
                       <label>NAME</label>
                          <input style="color: #000000;" name="name" value="<%=name %>" type="text" placeholder="Name"/>
                      ...
                      <div class="form-group">
                       <label>AGE</label>
                          <input style="color:  #000000;" name="age" value="<%=age %>"  type="text" placeholder="Age"/>
                     ...
                     <div class="col-sm-6">
                      <div class="form-group">
                       <label>CITY</label>
                          <input style="color:  #000000;" name="city" value="<%=city %>"  type="text" placeholder="City"/>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                       <label>STATE</label>
                          <input style="color:  #000000;" name="state" value="<%=state %>"  type="text" placeholder="State"/>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                       <label>EMAIL</label>
                          <input  style="color:  #000000;"  id="email" name="email" value="<%=email %>"  name="eamil" type="email" onblur="validateEmail(this);" placeholder="Email"/>
            ...
            <div class="col-md-12">
                    ...
                    <select style="color:  #000000;" name="gname">
                     ...
                     {
                    	 %>
                    <option style="color:  #000000;" value="<%=rs1.getInt(1) %>"><%=rs1.getString(2) %>  </option>
		...
		<tr align="center">
			...
			<td>
                   ...
                   <%--  <div class="col-md-12">
                     <div class="form-group">
                      <label> PROBLEM       </label>
                        <textarea style="color: #000000;"  id="message" name="message"  disabled placeholder="Your Problem"><%=prob%></textarea>
                      ...
                      <div class="form-group">
                       <label>CELL NO</label>
                          <input  style="color: #000000;" id="cell" name="cell"  type="text" value="<%=cell %>"   maxlength="10" placeholder="Cell No"/>
