        ...
        <div class="con-info">
		  ...
		  <div class='container'>
            ...
            <div class="col-md-6 col-sm-6"> <i class="ion-flag"></i>
              ...
              <h4><font style=" font-style: italic;">USER CHANGE PASSWORD PAGE</font></h4>
              <div id="contact_form">
                  <form action="<%=request.getContextPath()%>/ChangePassUser" method="get">
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                          <label>EXPERT ID</label>
                          <input style="color:  #000000;" name="uid" type="text" value="<%=uid%>"   readonly="readonly" placeholder="User Id" required/>
