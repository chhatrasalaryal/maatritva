     ...
     <!--  
        ...
        <div class="con-info">
		  ...
		  <div class='container'>
           ...
           <!--    <h4><font style=" font-style: italic;">RANKED SIMILAR QUESTIONS WITH ANSWERS </font></h4> -->
              <div id="contact_form">
			...
			%>
                      <label ><%=data+".  "  %>QUESTION       </label>
                        <input type="text" style="color: #000000;"  id="message" name="question" value="<%=rs.getString(3) %>" >
                                    <label> ANSWER       </label>
                    <input  type="text"  style="color: #000000;"  id="message" name="answer"  value="<%=rs.getString(6) %>">
               <%} %> 
	  <%--  	
      <table id="results" class="pretty-table"  border="2" width="120%" height="200%"   cellpadding="1"  id="user" style="position:absolute; top: -50px;">
...
<th scope="col">QUESTIONS</th>
   ...
   <%
	...
	<div id="pageNavPosition" style="position:absolute;top:80px;left:200px"></div>
<script type="text/javascript"><!--
