        ...
        <div class="con-info">
		  ...
		  <div class='container'>
            ...
            <div class="col-md-6 col-sm-6"> <i class="ion-flag"></i>
              ...
              <h4><font style=" font-style: italic;">CREATE QUESTION PAGE</font></h4>
              <div id="contact_form">
                <form action="<%=request.getContextPath()%>/UsercommonQuestions" method="get">
                    ...
                    <div class="col-md-12">
                     <div class="form-group">
                      <label> ASK QUESTION       </label>
                        <textarea style="color: #000000;"  name="question" placeholder="Your Question"></textarea>
